package dev.baloise.keycloak.demo;
            ...
            http
                    ...
                    .and()
                        .authorizeRequests()
                            ...
                            .antMatchers("/logout", "/", "/unsecured", "/favicon.ico", "/error").permitAll()
                            .antMatchers("/user").hasRole("demo-user-role")
                            .antMatchers("/admin").hasRole("demo-admin-role")
